...
import com.tukuri.ics.Fragment.Add_delivery_address_fragment;
...
public class Delivery_get_address_adapter extends RecyclerSwipeAdapter<Delivery_get_address_adapter.MyViewHolder> {
   ...
   // private List<Delivery_address_model> modelList;
    private ArrayList<Delivery_address_model> modelList;
    ...
    private String getsocity, gethouse, getphone, getpin, getname, getcharge,getadresdeliver,
            getaddress,getcity,getstate,getlandmark;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_address, tv_name, tv_phone, tv_charges,tv_adres_deliver;
           ...
           // tv_address = (TextView) view.findViewById(R.id.tv_adres_address);
            ...
            rb_select.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    getaddress = modelList.get(clickedPos).getHouse_address();
                    getcity = modelList.get(clickedPos).getCity();
                    getstate = modelList.get(clickedPos).getState();
                    getlandmark = modelList.get(clickedPos).getLandmark();
    ...
    public Delivery_get_address_adapter(ArrayList<Delivery_address_model> modelList) {
    ...
    public void onBindViewHolder(final Delivery_get_address_adapter.MyViewHolder holder, final int position) {
        ...
        holder.tv_adres_deliver.setText(mList.getHouse_no()+", "+ mList.getHouse_address()+", "+mList.getLandmark()+", "+mList.getCity()+", "+mList.getState()+", "+mList.getPincode());
        ...
        if (position == 0 /*&& mList.getIscheckd() && holder.rb_select.isChecked()*/) {
            ...
            getaddress = modelList.get(0).getHouse_address();
            getcity = modelList.get(0).getCity();
            getstate = modelList.get(0).getState();
            getlandmark = modelList.get(0).getLandmark();
        ...
        holder.btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               args.putString("socity_name", mList.getSocity_name());
                ...
                args.putParcelableArrayList("ListModel",modelList);
    ...
    public String getaddress() {
       /* String address = context.getResources().getString(R.string.reciver_name) + getname + "\n" + context.getResources().getString(R.string.reciver_mobile) + getphone +
        ...
        String address = context.getResources().getString(R.string.reciver_name) + getname + "\n" + context.getResources().getString(R.string.reciver_mobile) + getphone +
                "\n" + context.getResources().getString(R.string.pincode) + getpin +
                "\n" + context.getResources().getString(R.string.house_no) + gethouse +", "+getaddress+", "
                +getlandmark+", "+getcity+", "+getstate
                ;
    ...
    private void makeDeleteAddressRequest(String location_id,final int position) {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                BaseURL.DELETE_ADDRESS, params, new Response.Listener<JSONObject>() {
