...
public class Product_adapter extends RecyclerView.Adapter<Product_adapter.MyViewHolder>
    ...
    List<Decription_model> decription_models;
...
//                mrpPrice.setText(map.get("Mrp"));
                ((com.tukuri.ics.MainActivity) context).setCartCounter("" + dbcart.getCartCount());
...
//                        position, tv_contetiy.getText().toString());
    ...
    public Product_adapter(List<Product_model> modelList, Context context ,List<Decription_model> decription_models) {
