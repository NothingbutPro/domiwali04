...
import static com.tukuri.ics.Config.BaseURL.IS_LOGIN;
import static com.tukuri.ics.Config.BaseURL.KEY_DATE;
import static com.tukuri.ics.Config.BaseURL.KEY_EMAIL;
import static com.tukuri.ics.Config.BaseURL.KEY_HOUSE;
import static com.tukuri.ics.Config.BaseURL.KEY_ID;
import static com.tukuri.ics.Config.BaseURL.KEY_IMAGE;
import static com.tukuri.ics.Config.BaseURL.KEY_MOBILE;
import static com.tukuri.ics.Config.BaseURL.KEY_NAME;
import static com.tukuri.ics.Config.BaseURL.KEY_PASSWORD;
import static com.tukuri.ics.Config.BaseURL.KEY_PINCODE;
import static com.tukuri.ics.Config.BaseURL.KEY_SOCITY_ID;
import static com.tukuri.ics.Config.BaseURL.KEY_SOCITY_NAME;
import static com.tukuri.ics.Config.BaseURL.KEY_TIME;
import static com.tukuri.ics.Config.BaseURL.PREFS_NAME;
import static com.tukuri.ics.Config.BaseURL.PREFS_NAME2;
...
*/
    ...
    public void checkLogin() {
        ...
        if (!this.isLoggedIn()) {
            Intent loginsucces = new Intent(context, com.tukuri.ics.MainActivity.class);
...
public void updateData(String getname, String getphone, String getemail, String getimage) {
       ...
       // editor.putString(KEY_SOCITY_ID, socity_id);
        editor.putString(KEY_IMAGE, getimage);
       // editor.putString(KEY_HOUSE, house);
