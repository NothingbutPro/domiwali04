...
public class Change_password_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.tukuri.ics.MainActivity) getActivity()).setTitle(getResources().getString(R.string.change_password));
    ...
    private void makeChangePasswordRequest(String user_id, String new_password,
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                BaseURL.CHANGE_PASSWORD, params, new Response.Listener<JSONObject>() {
