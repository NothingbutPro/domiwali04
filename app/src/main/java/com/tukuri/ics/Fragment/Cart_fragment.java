...
import com.tukuri.ics.Adapter.Cart_adapter;
import com.tukuri.ics.Config.BaseURL;
import com.tukuri.ics.ContinueActivity;
...
public class Cart_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.tukuri.ics.MainActivity) getActivity()).setTitle(getResources().getString(R.string.tv_cart_title));
